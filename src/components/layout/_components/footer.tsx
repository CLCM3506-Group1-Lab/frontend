...
const Logo = (props: any) => {
  return (
    <svg
      ...
      {...props}
    >
      <text x="32" y="22" fill="currentColor" fontWeight="bold" font-size="20">
        CL Hub
      </text>
      <path
...
export const Footer = () => {
  return (
    <Box
      ...
      color={useColorModeValue("gray.900", "gray.800")}
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          <Stack spacing={6}>
            ...
            <Text fontSize={"sm"}>© 2010 — 2024</Text>
          </Stack>
          <Stack align={"flex-start"}>
            <Box fontWeight={"bold"} fontSize={"14px"} mb={2} as="a" href={"/"}>
              Home
            </Box>
          </Stack>
          <Stack align={"flex-start"}>
